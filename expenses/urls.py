...
urlpatterns = [
    ...
    path('groups/<int:group_id>/settle-up/', views.settle_up, name='settle_up'),
    path('groups/<int:group_id>/settlement-history/', views.settlement_history, name='settlement_history'),
]